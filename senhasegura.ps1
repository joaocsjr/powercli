...
New-VMHostAccount -server $vmhost -id  admseg  -Password "server@2020" -Description "usuario senha segura"
New-VMHostAccount -server $vmhost -id  _apl_mt4 -Password "server@2020" -Description "usuario senha segura"
