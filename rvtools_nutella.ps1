...
$ResultSet = $Report | ConvertTo-Html  -Head $a -Title $ReportTitle -Body "<center><img src=`"http://p2v.com.br/wp-content/uploads/2017/04/nutanix-1.jpg`"></center></br> <h1>$ReportTitle  </h1>`n<h5> <p><b> <i> Wintel & Virtualização  </i></b> </p> <p> Gerado em:$(Get-Date) </p> </p> Versão completa em CSV disponivel em: \\brslp1vw2pap046\f$\Scripts\export\ </h5>" 
...
#$recipients = "Joao.castro@domain.com"
